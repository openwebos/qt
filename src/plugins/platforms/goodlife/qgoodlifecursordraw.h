...
#ifndef QGOODLIFECURSORDRAW_H
#define QGOODLIFECURSORDRAW_H
...
#define GOODLIFE_SCREEN_WIDTH  1920
#define GOODLIFE_SCREEN_HEIGHT 1080

#define GOODLIFE_MOUSE_WIDTH  1280
#define GOODLIFE_MOUSE_HEIGHT 720
...
class QGoodLifeCursorDraw : public QObject
{
public:
    QGoodLifeCursorDraw();

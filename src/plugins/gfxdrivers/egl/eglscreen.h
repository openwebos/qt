...
class EglScreenSurfaceFunctions : public QGLScreenSurfaceFunctions
{
public:
    EglScreenSurfaceFunctions(EglScreen *s, int screenNum)
...
class EglScreen : public QGLScreen
{
public:
    EglScreen(int displayId);
    ~EglScreen();
